...
cartRouter.get("/get-carts-by-user/:user_id", authMiddleware, CartController.getByUser);
cartRouter.put("/update-cart/:xata_id", authMiddleware, CartController.update);
cartRouter.delete("/delete-cart/:xata_id", authMiddleware, CartController.delete);
